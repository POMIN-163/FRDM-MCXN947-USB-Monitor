...
#define USBD_VID           0xE6E9
#define USBD_PID           0x1122
...
/* 消息队列中用到的放置消息的内存池 */
static rt_uint8_t usb_msg_pool[64];
...
void cdc_acm_init(uint8_t busid, uintptr_t reg_base)
{
    ...
    /* 初始化消息队列 */
    rt_err_t result;
    result = rt_mq_init(&usb_mq,
                        "usb_mq",
                        &usb_msg_pool[0],        /* 内存池指向 usb_msg_pool */
                        34,                      /* 每个消息的大小是 34 字节 */
                        sizeof(usb_msg_pool),    /* 内存池的大小是 msg_pool 的大小 */
